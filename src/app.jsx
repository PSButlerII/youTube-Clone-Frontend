...
class App extends Component {
          ...
          items: [
            ...
            },
            {
              ...
              snippet: {
                ...
                title:
                  "FUNNY AND CUTE CAT VIDEOS TO START YOUR WEEK! 2021😸 | YUFUS",
                description:
                  "Hi cat lovers! The best and funniest cat videos ever! Cats are part of our life, we laugh at them so much.Funny cats are so adorable and cute. Just look at all ...",
                thumbnails: {
                  default: {
            ...
            },
            {
              ...
              snippet: {
                ...
                title:
                  "CATS will make you LAUGH YOUR HEAD OFF 😆😹🤣 Funny CAT compilation",
                description:
                  "CATS will make you LAUGH YOUR HEAD OFF Funny CAT compilation Thanks For Watching ! Please Like Share & Comment If You Like This Video !",
                thumbnails: {
                  default: {
  ...
  youTubeVideo = async (searchTerm) => {
    let response = await axios.get(
      `https://www.googleapis.com/youtube/v3/search?q=${searchTerm}&part=snippet&key=AIzaSyDMsnff0u4A96PStCHpTFtEkPLS_VD9W5A`
    );
    ...
    this.setState({
      ...
      selectedVideoThumbnailOne:
        response.data.items[1].snippet.thumbnails.high.url,
      ...
      selectedVideoThumbnailTwo:
        response.data.items[2].snippet.thumbnails.high.url,
      ...
      selectedVideoThumbnailThree:
        response.data.items[3].snippet.thumbnails.high.url,
      ...
      selectedVideoThumbnailFour:
        response.data.items[4].snippet.thumbnails.high.url,
    });
    this.setState({
